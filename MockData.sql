...
INSERT INTO FoodIngredient (FoodID, IngredientID, Quantity, Unit)
VALUES
    -- 1. Phở bò
    (1, 154, 100, 'g'),    -- Bánh phở
    (1, 75, 150, 'g'),     -- Thịt bò
    (1, 12, 10, 'g'),      -- Gừng tươi
    (1, 116, 5, 'g'),      -- Hành lá
    (1, 5, 20, 'ml'),      -- Nước mắm cá
    (1, 10, 2, 'g'),       -- Muối

    -- 2. Bánh mì thịt
    (2, 155, 50, 'g'),     -- Bánh mì
    (2, 71, 100, 'g'),     -- Thịt heo nạc
    (2, 122, 20, 'g'),     -- Dưa leo
    (2, 116, 5, 'g'),      -- Hành lá
    (2, 5, 10, 'ml'),      -- Nước mắm cá
    (2, 1, 15, 'g'),       -- Sốt mayonnaise

    -- 3. Cơm tấm sườn
    (3, 159, 150, 'g'),    -- Cơm trắng
    (3, 56, 200, 'g'),     -- Sườn heo
    (3, 5, 15, 'ml'),      -- Nước mắm cá
    (3, 93, 5, 'g'),       -- Tỏi
    (3, 16, 10, 'g'),      -- Đường cát

    -- 4. Bún chả
    (4, 149, 100, 'g'),    -- Bún
    (4, 71, 150, 'g'),     -- Thịt heo nạc
    (4, 5, 20, 'ml'),      -- Nước mắm cá
    (4, 93, 5, 'g'),       -- Tỏi
    (4, 16, 10, 'g'),      -- Đường cát
    (4, 100, 20, 'g'),     -- Rau sà lách

    -- 5. Gỏi cuốn
    (5, 32, 50, 'g'),      -- Tôm biển
    (5, 71, 50, 'g'),      -- Thịt heo nạc
    (5, 149, 30, 'g'),     -- Bún
    (5, 100, 10, 'g'),     -- Rau sà lách
    (5, 5, 10, 'ml'),      -- Nước mắm cá

    -- 6. Bánh xèo
    (6, 152, 50, 'g'),     -- Bột gạo tẻ
    (6, 32, 50, 'g'),      -- Tôm biển
    (6, 71, 50, 'g'),      -- Thịt heo nạc
    (6, 80, 10, 'ml'),     -- Dầu oliu
    (6, 118, 20, 'g'),     -- Giá

    -- 7. Chả giò
    (7, 152, 30, 'g'),     -- Bột gạo tẻ
    (7, 71, 50, 'g'),      -- Thịt heo nạc
    (7, 92, 10, 'g'),      -- Mộc nhĩ
    (7, 80, 15, 'ml'),     -- Dầu oliu
    (7, 5, 10, 'ml'),      -- Nước mắm cá

    -- 8. Canh chua cá lóc
    (8, 42, 200, 'g'),     -- Cá trê (thay cá lóc)
    (8, 134, 50, 'g'),     -- Cà chua
    (8, 89, 50, 'g'),      -- Dứa
    (8, 5, 15, 'ml'),      -- Nước mắm cá
    (8, 10, 2, 'g'),       -- Muối
    ...
    (9, 41, 100, 'g'),     -- Cua đồng
    (9, 134, 50, 'g'),     -- Cà chua
    (9, 5, 15, 'ml'),      -- Nước mắm cá
    (9, 116, 5, 'g'),      -- Hành lá

    -- 10. Cá kho tộ
    (10, 49, 200, 'g'),    -- Cá hồi
    (10, 5, 20, 'ml'),     -- Nước mắm cá
    (10, 16, 15, 'g'),     -- Đường cát
    (10, 11, 5, 'g'),      -- Hạt tiêu
    (10, 93, 5, 'g'),      -- Tỏi

    -- 11. Bánh cuốn
    (11, 152, 50, 'g'),    -- Bột gạo tẻ
    (11, 71, 50, 'g'),     -- Thịt heo nạc
    (11, 92, 10, 'g'),     -- Mộc nhĩ
    (11, 80, 10, 'ml'),    -- Dầu oliu
    (11, 5, 10, 'ml'),     -- Nước mắm cá

    -- 12. Chè đậu đen
    (12, 141, 50, 'g'),    -- Đậu đen
    (12, 16, 20, 'g'),     -- Đường cát
    (12, 19, 20, 'ml'),    -- Sữa đặc có đường

    -- 13. Bánh bèo
    (13, 152, 50, 'g'),    -- Bột gạo tẻ
    (13, 32, 30, 'g'),     -- Tôm biển
    (13, 116, 5, 'g'),     -- Hành lá
    (13, 80, 10, 'ml'),    -- Dầu oliu
    (13, 5, 10, 'ml'),     -- Nước mắm cá

    -- 14. Bánh ướt
    (14, 152, 50, 'g'),    -- Bột gạo tẻ
    (14, 71, 50, 'g'),     -- Thịt heo nạc
    (14, 116, 5, 'g'),     -- Hành lá
    (14, 5, 10, 'ml'),     -- Nước mắm cá

    -- 15. Bánh canh cua
    (15, 152, 100, 'g'),   -- Bột gạo tẻ
    (15, 41, 100, 'g'),    -- Cua đồng
    (15, 116, 5, 'g'),     -- Hành lá
    (15, 5, 15, 'ml'),     -- Nước mắm cá

    -- 16. Bánh tét
    (16, 160, 100, 'g'),   -- Cơm gạo nếp
    (16, 140, 50, 'g'),    -- Đậu xanh
    (16, 71, 50, 'g'),     -- Thịt heo nạc
    (16, 11, 2, 'g'),      -- Hạt tiêu

    -- 17. Bánh chưng
    (17, 160, 100, 'g'),   -- Cơm gạo nếp
    (17, 140, 50, 'g'),    -- Đậu xanh
    (17, 71, 50, 'g'),     -- Thịt heo nạc
    (17, 11, 2, 'g'),      -- Hạt tiêu

    -- 18. Bánh đúc
    (18, 152, 50, 'g'),    -- Bột gạo tẻ
    (18, 116, 5, 'g'),     -- Hành lá
    (18, 5, 10, 'ml'),     -- Nước mắm cá
    (18, 80, 10, 'ml'),    -- Dầu oliu

    -- 19. Bánh khọt
    (19, 152, 50, 'g'),    -- Bột gạo tẻ
    (19, 32, 30, 'g'),     -- Tôm biển
    (19, 80, 10, 'ml'),    -- Dầu oliu
    (19, 116, 5, 'g'),     -- Hành lá

    -- 20. Bánh tráng trộn
    (20, 152, 30, 'g'),    -- Bột gạo tẻ (bánh tráng)
    (20, 27, 10, 'g'),     -- Trứng gà
    (20, 30, 20, 'g'),     -- Tôm khô
    (20, 5, 10, 'ml'),     -- Nước mắm cá
    (20, 16, 5, 'g'),      -- Đường cát

    -- 21. Salad ức gà
    (21, 74, 150, 'g'),    -- Thịt gà ta
    (21, 100, 50, 'g'),    -- Rau sà lách
    (21, 82, 10, 'ml'),    -- Chanh
    (21, 80, 10, 'ml'),    -- Dầu oliu
    (21, 134, 20, 'g'),    -- Cà chua

    -- 22. Cháo yến mạch
    (22, 152, 50, 'g'),    -- Bột gạo tẻ (thay yến mạch)
    (22, 85, 50, 'g'),     -- Chuối tiêu
    (22, 21, 100, 'ml'),   -- Sữa bò tươi
    (22, 16, 10, 'g'),     -- Đường cát

    -- 23. Smoothie bơ chuối
    (23, 85, 50, 'g'),     -- Chuối tiêu
    (23, 21, 100, 'ml'),   -- Sữa bò tươi
    (23, 15, 10, 'g'),     -- Mật ong

    -- 24. Cá hồi áp chảo
    (24, 49, 200, 'g'),    -- Cá hồi
    (24, 80, 10, 'ml'),    -- Dầu oliu
    (24, 96, 100, 'g'),    -- Súp lơ xanh
    (24, 11, 2, 'g'),      -- Hạt tiêu
    (24, 10, 1, 'g'),      -- Muối

    -- 25. Súp lơ hấp
    (25, 96, 150, 'g'),    -- Súp lơ xanh
    (25, 80, 10, 'ml'),    -- Dầu oliu
    (25, 10, 1, 'g'),      -- Muối

    -- 26. Bánh pancake chuối yến mạch
    (26, 152, 50, 'g'),    -- Bột gạo tẻ (thay yến mạch)
    (26, 85, 50, 'g'),     -- Chuối tiêu
    (26, 27, 20, 'g'),     -- Trứng gà
    (26, 80, 10, 'ml'),    -- Dầu oliu

    -- 27. Trà gừng mật ong
    (27, 12, 10, 'g'),     -- Gừng tươi
    (27, 15, 15, 'g'),     -- Mật ong
    (27, 16, 5, 'g'),      -- Đường cát

    -- 28. Xôi gạo lứt
    (28, 158, 100, 'g'),   -- Cơm gạo lứt đỏ
    (28, 140, 20, 'g'),    -- Đậu xanh
    (28, 80, 10, 'ml'),    -- Dầu oliu

    -- 29. Súp bí đỏ
    (29, 135, 150, 'g'),   -- Bí ngô
    (29, 21, 100, 'ml'),   -- Sữa bò tươi
    (29, 10, 1, 'g'),      -- Muối

    -- 30. Salad cá ngừ
    (30, 47, 150, 'g'),    -- Cá ngừ
    (30, 100, 50, 'g'),    -- Rau sà lách
    (30, 80, 10, 'ml'),    -- Dầu oliu
    (30, 134, 20, 'g'),    -- Cà chua

    -- 31. Lẩu gà lá é
    (31, 74, 300, 'g'),    -- Thịt gà ta
    (31, 111, 20, 'g'),    -- Lá lốt
    (31, 5, 20, 'ml'),     -- Nước mắm cá
    (31, 12, 10, 'g'),     -- Gừng tươi
    (31, 93, 5, 'g'),      -- Tỏi

    -- 32. Lẩu thái hải sản
    (32, 32, 100, 'g'),    -- Tôm biển
    (32, 37, 100, 'g'),    -- Mực tươi
    (32, 34, 100, 'g'),    -- Sò
    (32, 134, 50, 'g'),    -- Cà chua
    (32, 5, 20, 'ml'),     -- Nước mắm cá

    -- 33. Lẩu bò nhúng giấm
    (33, 75, 300, 'g'),    -- Thịt bò
    (33, 5, 20, 'ml'),     -- Nước mắm cá
    (33, 149, 100, 'g'),   -- Bún
    (33, 100, 20, 'g'),    -- Rau sà lách

    -- 34. Bún bò Huế
    (34, 149, 100, 'g'),   -- Bún
    (34, 75, 150, 'g'),    -- Thịt bò
    (34, 68, 100, 'g'),    -- Chân giò heo
    (34, 5, 20, 'ml'),     -- Nước mắm cá
    (34, 105, 5, 'g'),     -- Ớt đỏ

    -- 35. Hủ tiếu Nam Vang
    (35, 149, 100, 'g'),   -- Bún
    (35, 32, 50, 'g'),     -- Tôm biển
    (35, 71, 50, 'g'),     -- Thịt heo nạc
    (35, 25, 10, 'g'),     -- Trứng cút
    (35, 116, 5, 'g'),     -- Hành lá

    -- 36. Bánh đúc mặn
    (36, 152, 50, 'g'),    -- Bột gạo tẻ
    (36, 140, 20, 'g'),    -- Đậu xanh
    (36, 5, 10, 'ml'),     -- Nước mắm cá
    (36, 116, 5, 'g'),     -- Hành lá

    -- 37. Mì Quảng
    (37, 149, 100, 'g'),   -- Bún
    (37, 32, 50, 'g'),     -- Tôm biển
    (37, 71, 50, 'g'),     -- Thịt heo nạc
    (37, 27, 20, 'g'),     -- Trứng gà
    (37, 5, 15, 'ml'),     -- Nước mắm cá

    -- 38. Bánh giò
    (38, 152, 50, 'g'),    -- Bột gạo tẻ
    (38, 71, 50, 'g'),     -- Thịt heo nạc
    (38, 92, 10, 'g'),     -- Mộc nhĩ
    (38, 11, 2, 'g'),      -- Hạt tiêu

    -- 39. Xôi xéo
    (39, 160, 100, 'g'),   -- Cơm gạo nếp
    (39, 140, 50, 'g'),    -- Đậu xanh
    (39, 80, 10, 'ml'),    -- Dầu oliu
    (39, 116, 5, 'g'),     -- Hành lá

    -- 40. Cá nướng
    (40, 49, 200, 'g'),    -- Cá hồi
    (40, 5, 15, 'ml'),     -- Nước mắm cá
    (40, 93, 5, 'g'),      -- Tỏi
    (40, 11, 2, 'g'),      -- Hạt tiêu

    -- 41. Ốc hương xào bơ tỏi
    (41, 36, 200, 'g'),    -- Ốc bươu (thay ốc hương)
    (41, 93, 10, 'g'),     -- Tỏi
    (41, 80, 15, 'ml'),    -- Dầu oliu
    (41, 11, 2, 'g'),      -- Hạt tiêu

    -- 42. Bánh bột lọc
    (42, 152, 50, 'g'),    -- Bột gạo tẻ
    (42, 32, 30, 'g'),     -- Tôm biển
    (42, 71, 30, 'g'),     -- Thịt heo nạc
    (42, 5, 10, 'ml'),     -- Nước mắm cá

    -- 43. Cơm gà
    (43, 159, 150, 'g'),   -- Cơm trắng
    (43, 74, 200, 'g'),    -- Thịt gà ta
    (43, 5, 15, 'ml'),     -- Nước mắm cá
    (43, 122, 20, 'g'),    -- Dưa leo

    -- 44. Chè bắp
    (44, 157, 50, 'g'),    -- Bắp ngô
    (44, 16, 20, 'g'),     -- Đường cát
    (44, 19, 20, 'ml'),    -- Sữa đặc có đường

    -- 45. Gỏi bò bóp thấu
    (45, 75, 150, 'g'),    -- Thịt bò
    (45, 82, 10, 'ml'),    -- Chanh
    (45, 5, 15, 'ml'),     -- Nước mắm cá
    (45, 115, 20, 'g'),    -- Hành tây

    -- 46. Tiết canh vịt
    (46, 69, 150, 'g'),    -- Thịt vịt
    (46, 5, 10, 'ml'),     -- Nước mắm cá
    (46, 116, 5, 'g'),     -- Hành lá

    -- 47. Lòng xào dưa
    (47, 57, 150, 'g'),    -- Tai heo (thay lòng)
    (47, 110, 50, 'g'),    -- Măng chua
    (47, 93, 5, 'g'),      -- Tỏi
    (47, 80, 10, 'ml'),    -- Dầu oliu

    -- 48. Dê tái chanh
    (48, 53, 150, 'g'),    -- Thịt dê
    (48, 82, 10, 'ml'),    -- Chanh
    (48, 5, 15, 'ml'),     -- Nước mắm cá
    (48, 12, 5, 'g'),      -- Gừng tươi

    -- 49. Bánh khoai mì nướng
    (49, 145, 100, 'g'),   -- Khoai môn (thay khoai mì)
    (49, 16, 20, 'g'),     -- Đường cát
    (49, 19, 20, 'ml'),    -- Sữa đặc có đường

    -- 50. Gỏi ngó sen tôm thịt
    (50, 106, 100, 'g'),   -- Ngó sen
    (50, 32, 50, 'g'),     -- Tôm biển
    (50, 71, 50, 'g'),     -- Thịt heo nạc
    (50, 5, 15, 'ml'),     -- Nước mắm cá
    (50, 29, 10, 'g');     -- Bánh phồng tôm
