...
public partial class NutriDietContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AirecommendMealLogId).HasName("PK__AIRecomm__9CD3D5F81545C482");
        ...
        {
            entity.HasKey(e => e.AirecommendMealPlanId).HasName("PK__AIRecomm__CF019A629363118E");
        ...
        {
            entity.HasKey(e => e.AllergyId).HasName("PK__Allergy__A49EBE62476A599F");
            ...
            entity.HasMany(d => d.Ingredients).WithMany(p => p.Allergies)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("AllergyId", "IngredientId").HasName("PK__AllergyI__1F745545F622BE42");
        ...
        {
            entity.HasKey(e => e.CuisineId).HasName("PK__CuisineT__B1C3E7ABE5CDE2EB");

            entity.ToTable("CuisineType");

            entity.HasIndex(e => e.CuisineName, "UQ__CuisineT__2C77DCC8FA5D5CE2").IsUnique();
        ...
        {
            entity.HasKey(e => e.DiseaseId).HasName("PK__Disease__69B533A91323AD9D");
            ...
            entity.HasMany(d => d.Ingredients).WithMany(p => p.Diseases)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("DiseaseId", "IngredientId").HasName("PK__DiseaseI__D25FD88E786B333E");
        ...
        {
            entity.HasKey(e => e.FoodId).HasName("PK__Food__856DB3CB5BDCDC2D");

            entity.ToTable("Food");

            entity.HasIndex(e => e.FoodName, "UQ__Food__81B4FC25A68AB472").IsUnique();
            ...
            entity.HasMany(d => d.Ingredients).WithMany(p => p.Foods)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("FoodId", "IngredientId").HasName("PK__FoodIngr__3E8758ECED623CC9");
        ...
        {
            entity.HasKey(e => e.SubstitutionId).HasName("PK__FoodSubs__95BE7DE47E79C508");
        ...
        {
            entity.HasKey(e => e.ProfileId).HasName("PK__GeneralH__290C888432EDBDC2");
        ...
        {
            entity.HasKey(e => e.HealthcareIndicatorId).HasName("PK__Healthca__B6218104CB053A53");
        ...
        {
            entity.HasKey(e => e.IngredientId).HasName("PK__Ingredie__BEAEB27A346B91FE");

            entity.ToTable("Ingredient");

            entity.HasIndex(e => e.IngredientName, "UQ__Ingredie__A1B2F1CC1FB641B5").IsUnique();
        ...
        {
            entity.HasKey(e => e.MealLogId).HasName("PK__MealLog__0ED21C52259686AF");
        ...
        {
            entity.HasKey(e => e.DetailId).HasName("PK__MealLogD__135C314DE2EC9C10");
        ...
        {
            entity.HasKey(e => e.MealPlanId).HasName("PK__MealPlan__0620DB5671CE9C13");
        ...
        {
            entity.HasKey(e => e.MealPlanDetailId).HasName("PK__MealPlan__37DC012B1D1FAB2E");
        ...
        {
            entity.HasKey(e => e.MyFoodId).HasName("PK__MyFood__4A2439358102B8DE");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E1267699572");
        ...
        {
            entity.HasKey(e => e.PackageId).HasName("PK__Package__322035ECACA2F887");

            entity.ToTable("Package");

            entity.HasIndex(e => e.PackageName, "UQ__Package__73856F7A7F82E369").IsUnique();
        ...
        {
            entity.HasKey(e => e.GoalId).HasName("PK__Personal__8A4FFF3165DAD8C9");
        ...
        {
            entity.HasKey(e => e.RecipeId).HasName("PK__RecipeSu__FDD988D071B4F676");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__8AFACE3A067D5868");

            entity.ToTable("Role");

            entity.HasIndex(e => e.RoleName, "UQ__Role__8A2B61600D5117A8").IsUnique();
        ...
        {
            entity.HasKey(e => e.ConfigId).HasName("PK__SystemCo__C3BC333CD2055B8C");

            entity.ToTable("SystemConfiguration");

            entity.HasIndex(e => e.Name, "UQ__SystemCo__737584F64BAEFBE6").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC55AF478E");

            entity.ToTable("User");

            entity.HasIndex(e => e.Email, "UQ__User__A9D10534E49DA43A").IsUnique();
            ...
            entity.HasMany(d => d.Allergies).WithMany(p => p.Users)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("UserId", "AllergyId").HasName("PK__UserAlle__2DC1274AD08EB12C");
            ...
            entity.HasMany(d => d.Diseases).WithMany(p => p.Users)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("UserId", "DiseaseId").HasName("PK__UserDise__91139F96ADE5269C");
        ...
        {
            entity.HasKey(e => e.UserFoodPreferenceId).HasName("PK__UserFood__997D6AD76B899377");
        ...
        {
            entity.HasKey(e => e.UserIngreDientPreferenceId).HasName("PK__UserIngr__27A229AF695FC840");
        ...
        {
            entity.HasKey(e => e.UserPackageId).HasName("PK__UserPack__AE9B91FA748B09BB");
